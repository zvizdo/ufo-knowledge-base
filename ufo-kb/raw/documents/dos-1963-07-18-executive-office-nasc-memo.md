---
title: "DOS — Executive Office Memo, National Aeronautics and Space Council, 1963-07-18"
agency: Department of State
document_type: Executive Office memo (NASC)
date: 1963-07-18
location: United States (Executive Office of the President)
provenance: gov-release / PURSUE Release 01
source_pdf: "59_214434_sp_16_[7.18.1963].pdf"
source_pdfs:
  - "59_214434_sp_16_[7.18.1963].pdf"
---

# DOS — Executive Office Memo, National Aeronautics and Space Council, 1963-07-18

> Memo from the Executive Office of the President, National Aeronautics and Space Council, dated 1963-07-18.

**Filename ambiguity:** there are two source PDFs whose names differ only by square brackets — `59_214434_sp_16_[7.18.1963].pdf` (this document, **1963**) and `59_214434_sp_16_7.18.1963.pdf` (a different document dated **1952** despite the filename).
...
![](./dos-1963-07-18-executive-office-nasc-memo_assets/59_214434_sp_16_[7.18.1963]___page_0_Picture_4.jpeg)
...
OFFICIAL USE ONLY further funtation of the state of the state of the state of the state of the state of the state of the state of the state of the state of the state of the state of the state of the state of the state of the state of the state of the state of the state of the state of the state of the state of the state of the state of the state of the state of the state of the state of the state of the state of the state of the state of the state of the state of the state of the state of the state of the state of the state of the state of the state of the state of the state of the state of the state of the state of the state of the state of the state of the state of the state of the state of the state of the state of the state of the state of the state of the state of the state of the state of the state of the state of the state of the state of the state of the state of the state of the state of the state of the state of the state of the state of the state of the state of the state of the state of the state of the state of the state of the state of the state of the state of the state of the state of the state of the state of the state of the state of the state of the state of the state of the state of the state of the state of the state of the state of the state of the state of the state of the state of the state of the state of the state of the state of the state of the state of the state of the state of the state of the state of the state of the state of the state of the state of the state of the state of the state of the state of the state of the state of the state of the state of the state of the state of the state of the state of the state of the state of the state of the state of the state of the state of the state of the state of the state of the state of the state of the state of the state of the state of the state of the state of the state of the state of the state of the state of the state of the state of the state of the state of the state of the state of the state of the state of the state of the s
...
(1) The discovery of hot gasses eminating from the crater Alphonsus when the moon was supposedly dead. This would be considered evidence of civilization and, since Alphonsus is close to the visible edge, interpreted to mean that the other side of the moon was teaming with population which had begun

![](./dos-1963-07-18-executive-office-nasc-memo_assets/59_214434_sp_16_[7.18.1963]___page_2_Picture_5.jpeg)
