---
type: entity
name: Advanced Theoretical Physics Working Group
aliases: [ATPWG, Advanced Theoretical Physics Group, ATP Working Group]
roles: []
affiliations: []
firsthand_claims: []
...
**Significance**: The ATPWG represents the institutional bridge between the [[stargate-program]] era (psi research as military intelligence tool) and the AATIP/AAWSAP era (UAP physics as defense intelligence problem). Its members carried programmatic continuity across the gap between Cold War psi programs and post-2007 official UAP investigation.
...
- [[physics-lockdown]] — the claim that advanced UAP physics was known but sequestered; ATPWG is the non-public side of that knowledge
