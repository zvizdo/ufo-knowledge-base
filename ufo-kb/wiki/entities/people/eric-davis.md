...
affiliations: [Institute for Advanced Studies at Austin, EarthTech International, Aerospace Corporation, DIA]
firsthand_claims:
  - Received briefing from Admiral Thomas Wilson confirming crash retrieval and reverse-engineering programs (the Wilson-Davis memo)
  - Gave all his accumulated NIDS/BASS/AAWSAP data to David Grusch, enabling Grusch to find 40 witnesses
  - Received classified briefing from program insiders that NO ARVs were built and no reverse-engineering progress was made after "several decades of best efforts"
  - Saw classified evidence (documents, photos, reports from CIA asset) that Russia has had at least one crash retrieval (late 1980s era)
  - Had conversations with George H.W. Bush in 2003 about Bush's CIA Director briefing on a 1960s UAP event
  - Was offered role as branch chief scientist at CIA's WINPAC in 2003 (never started)
  - Briefed Senate SSCI staff (2019) and Senate SASC staff (2022, in Huntsville, AL) in classified settings
  - "The alleged Roswell crash was real. There was a there there really happened." (firsthand assertion based on research contacts)
  - Personally met approximately 5 people from crash retrieval programs
  - Crash retrieval programs have "no physicists doing legitimate physics" — identified as the structural cause of no reverse-engineering progress
  - Bob Lazar was "a radiation health monitor for Kimberly Meyer company" (logistics company servicing Los Alamos / Area 51); "He never had security clearances. He never graduated — never — he dropped out of his first year of college."
  - Wilson-Davis Pentagon meeting was summer 1997; Wilson's budget funded the WOSAP program without his knowledge; program had "hundreds of people" and material "that doesn't seem to be of human origin"
  - Crash retrievals are "born secret" under the Atomic Energy Act of 1954 — routed to DOE then to Lockheed, Northrop, aerospace contractors
  - Jeffrey Epstein bought Zoro Ranch in 1993 "with the explicit intent of being near retired Los Alamos physicists"; DOE security was "so lax" this was feasible
  - His traversable wormhole research concluded: "You're going to create a wormhole on demand… You should be able to. That's what my research showed."
  - NNSA Nevada contacts (Director of Intelligence, Director of Counter-Intelligence, AFIO members) helped facilitate the Wilson-Davis meeting; John Alexander also had NNSA Las Vegas connections
first_seen_in: raw/youtube-transcripts/5OUzGygIrSw.md
sources: [raw/youtube-transcripts/5OUzGygIrSw.md, raw/youtube-transcripts/8TYMQOUDQBo.md, raw/youtube-transcripts/LnAiNChnuEQ.md, raw/youtube-transcripts/fyX8V1XXmQM.md, raw/youtube-transcripts/xnxasfyHtfo.md]
tags: [physicist, metric-engineering, warp-drive, wilson-davis, puthoff, hal-puthoff, reverse-engineering, exotic-propulsion, aawsap, grusch, whistleblower, congressional-briefing, roswell, crash-retrieval, traversable-wormholes, doe-jurisdiction, epstein-los-alamos]
---
